...
const fileItem = tv({
  slots: {
    ...
    icon: 'dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500 rounded-full border-4 border-violet-100 bg-violet-200 p-2 text-violet-600',
    deleteButton: '',
  },
  ...
  variants: {
    state: {
      ...
      error: {
        container:
          'dark:bg-error-500/5 dark:border-error-500/30 bg-error-25 border-error-300',
        icon: 'dark:bg-error-500/5 dark:border-error-500/30 dark:text-error-400 border-error-50 bg-error-100 text-error-600',
        deleteButton:
          'dark:text-error-400 dark:hover:text-error-300 text-error-700 hover:text-error-900 hover:bg-error-50',
      },
    },
  },
  defaultVariants: {
