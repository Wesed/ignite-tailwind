...
export function NavItem({ title, icon: Icon }: NavItemProps) {
  return (
    <a
      href=""
      className="group flex items-center gap-3 rounded px-3 py-2 hover:bg-violet-50 focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-4 dark:hover:bg-zinc-800"
    >
